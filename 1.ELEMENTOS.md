...
![Modelo de construcción de prototipos](prototipos.png)
...
![Modelo en espiral](espiral-poo.png)
...
![Pizarra kanban](kanban-board.png)
...
- Para obtener código binario ejecutable tenemos 2 opciones:
  ...
  - __Interpretar__ -no obtenemos archivo ejecutable. Se lo pasa a la CPU para que lo ejecute-


### Proceso de compilación/interpretación

- La compilación/interpretación del código fuente se lleva a cabo en dos fases:
  1. __Análisis léxico__ -comprobar ortografía (palabras y símbolos)-
  2. __Análisis sintáctico__ -orden correcto (palabras y símbolos)-
...
- Según la forma en la que operan:
  ...
  - __Imperativos__: indicamos los pasos a seguir para obtener un resultado.-casi todos (java,c,c++...)-
